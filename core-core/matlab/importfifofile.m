...
%
%   REPORTFIFOARRAY = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data
%   from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   reportfifoarray = importfile('report_fifo_array.csv', 2, 129);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2018/04/17 09:54:11
...
reportfifoarray = [dataArray{1:end-1}];
