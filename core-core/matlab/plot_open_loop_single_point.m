...
idx = find( (ArrayLengthBlocks == ArrayLen) & (BlockSizeint32_tElements == BlockSize) & (InitialNOPs == InitialNOP) );
filterCond = ['(ArrayLengthBlocks == ' num2str(ArrayLen) ') & (BlockSizeint32_tElements == ' num2str(BlockSize) ') & (InitialNOPs == ' num2str(InitialNOP) ')'];
