...
%  CLOCKCYCLESCYCLETIMEMS, CLOCKRDTSC, EXPECTEDBLOCKIDCORE_Client,
...
%
%  Example:
%  [ArrayLengthBlocks, BlockSizeint32_tElements, BalancingNOPs, InitialNOPs, CheckPeriod, SteadyClockWalltimems, ClockCyclesCycleTimems, Clockrdtsc, ExpectedBlockIDCore_Client, StartBlockIDCore_Client, EndBlockIDCore_Client, ErroredCore_Client, ErrorSourceCore_Client, TransactionCore_Client, FullnessStartCore_Client, FullnessEndCore_Client, ExpectedBlockIDCore_Server, StartBlockIDCore_Server, EndBlockIDCore_Server, ErroredCore_Server, ErrorSourceCore_Server, TransactionCore_Server] = importfile("/Users/cyarp/git/benchmarking-github/core-core/results/bwrc-sr-amd-32c/open_loop/results_open_loop_single_point_tracker__Server096_100trials_2_Client_ClientblockArray_reboot/report_open_loop_fullness_tracker_raw.csv", [2, Inf]);
%
%  See also READTABLE.
%
% Auto-generated by MATLAB on 17-Jan-2020 13:38:1_Server
...
opts.VariableTypes = ["double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "categorical", "categorical", "double", "string", "string", "double", "double", "double", "categorical", "categorical", "double"];
...
opts = setvaropts(opts, ["FullnessStartCore_Client", "FullnessEndCore_Client"], "WhitespaceRule", "preserve");
opts = setvaropts(opts, ["ErroredCore_Client", "ErrorSourceCore_Client", "FullnessStartCore_Client", "FullnessEndCore_Client", "ErroredCore_Server", "ErrorSourceCore_Server"], "EmptyFieldRule", "auto");
