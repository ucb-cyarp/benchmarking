...
CREATE TABLE result_db.results_tbl(
  ...
  "softirq TIMER Start [Core Server]" TEXT,
  "softirq TIMER End [Core Server]" TEXT,
  "softirq Other Start [Core Server]" TEXT,
  "softirq Other End [Core Server]" TEXT,
  ...
  "softirq TIMER Start [Core Client]" TEXT,
  "softirq TIMER End [Core Client]" TEXT,
  "softirq Other Start [Core Client]" TEXT,
  "softirq Other End [Core Client]" TEXT,
