...
#include "statistics.h"
    ...
    {
        #if PRINT_HEADER == 1
            printf("[AVX] ===== Load/Divide/Store 8 Packed 32 bit Signed Floating Point Numbers (_mm256_div_ps) =====\n");
        #endif
        ...
        for(int trial = 0; trial<TRIALS; trial++)
        {
            ...
            kernel_mm256_div_ps(a_m256, b_m256, c_m256);
    ...
    {
        #if PRINT_HEADER == 1
            printf("[AVX] ===== Load/Divide/Store 4 Packed 64 bit Signed Floating Point Numbers (_mm256_div_pd) =====\n");
        #endif
        ...
        for(int trial = 0; trial<TRIALS; trial++)
        {
            ...
            kernel_mm256_div_pd(a_m256d, b_m256d, c_m256d);
