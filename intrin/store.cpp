...
#include "statistics.h"
    ...
    void test_mm256_store_si256_int8()
    {
        ...
        for(int trial = 0; trial<TRIALS; trial++)
        {
            ...
            kernel_mm256_store_si256_int8(a_m256);
    ...
    {
        #if PRINT_HEADER == 1
            printf("[AVX] ===== Store 16 Packed Signed 16 Bit Integers (_mm256_store_si256) =====\n");
        #endif
        ...
        for(int trial = 0; trial<TRIALS; trial++)
        {
            ...
            kernel_mm256_store_si256_int16(a_m256);
    ...
    {
        #if PRINT_HEADER == 1
            printf("[AVX] ===== Store 8 Packed Signed 32 Bit Integers (_mm256_store_si256) =====\n");
        #endif
        ...
        for(int trial = 0; trial<TRIALS; trial++)
        {
            ...
            kernel_mm256_store_si256_int32(a_m256);
    ...
    {
        #if PRINT_HEADER == 1
            printf("[AVX] ===== Store 8 Packed 32 bit Signed Floating Point Numbers (_mm256_store_ps) =====\n");
        #endif
    ...
    {
        #if PRINT_HEADER == 1
            printf("[AVX] ===== Store 4 Packed 64 bit Signed Floating Point Numbers (_mm256_store_pd) =====\n");
        #endif
