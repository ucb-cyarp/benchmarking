...
{
    #if PRINT_HEADER == 1
        printf("[AVX2] ===== Load/Add/Store 32 Packed 8 bit Signed Integers (_mm256_add_epi8) =====\n");
    #endif
...
{
    #if PRINT_HEADER == 1
        printf("[AVX2] ===== Load/Add/Store 16 Packed 16 bit Signed Integers (_mm256_add_epi16) =====\n");
    #endif
...
{
    #if PRINT_HEADER == 1
        printf("[AVX2] ===== Load/Add/Store 8 Packed 32 bit Signed Integers (_mm256_add_epi32) =====\n");
    #endif
...
{
    #if PRINT_HEADER == 1
        printf("[AVX] ===== Load/Add/Store 8 Packed 32 bit Signed Floating Point Numbers (_mm256_add_ps) =====\n");
    #endif
...
{
    #if PRINT_HEADER == 1
        printf("[AVX] ===== Load/Add/Store 4 Packed 64 bit Signed Floating Point Numbers (_mm256_add_pd) =====\n");
    #endif
