...
%% Open DB
conn = sqlite('fir-varients-results4_1.db', 'readonly'); %Do not need to write into the DB
...
kernelInstTitles = {'Naive', 'Circular Buffer w/ Mod', 'Circular Buffer w/o Mod', 'Circular Buffer w/ Mod - Reverse', 'Circular Buffer w/o Mod - Reverse', 'Naive Unroll 2',  'Naive Unroll 4'};

io_lens = [12, 12, 12, 12, 12, 12, 12];
%io_lens = [20, 20, 20, 20, 20, 20, 20];
%io_lens = [1, 1, 1, 1, 1, 1, 1];
