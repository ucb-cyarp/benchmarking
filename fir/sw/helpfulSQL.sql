select Processor.ProcessorID as 'Processor ID', Processor.Name as 'Processor Name', BaseISA.Name as 'Base ISA Name', ISAExtension.Name as 'ISA Extension' from 
